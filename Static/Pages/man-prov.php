...
<div class="main">
 ...
 <!-- HEADER -->
  ...
  <div class="tabs">
    ...
    <a href="man-prov.php" class="active">Proveedores</a>
  ...
  <div class="content">
    ...
    <div class="dashboard-top">
      <div>
        ...
        <p><?= count($proveedores) ?> proveedores registrados</p>
      </div>
    ...
    <div class="modal-overlay <?= $editData ? 'show' : '' ?>" id="modal-form">
      <div class="modal">
        ...
        <form method="POST">
          <input type="hidden" name="IdProveedor" value="<?= $editData['IdProveedor'] ?? '' ?>">
...
<?php foreach($proveedores as $fila): ?>
      <tr>
        ...
        <td><?= $fila['Estado'] ?></td>
        <td>
          <a href="?edit=<?= $fila['IdProveedor'] ?>" class="btn btn-small btn-green" >Edit</a>
          <a href="?delete=<?= $fila['IdProveedor'] ?>" class="btn btn-small btn-red" onclick="return confirm('¿Deseas eliminar el registro correspondiente al siguiente id = <?= $fila['IdProveedor'] ?> ?')"> Delete </a>
        </td>
      </tr>
<?php endforeach; ?>
    </tbody>
