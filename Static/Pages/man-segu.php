...
<div class="main">
 ...
 <!-- HEADER -->
  ...
  <div class="tabs">
    <a href="man-segu.php" class="active">Seguros</a>
  ...
  <div class="content">
    ...
    <div class="dashboard-top">
      <div>
        ...
        <p><?= count($seguros) ?> seguros registrados</p>
      </div>
...
<?php foreach($seguros as $fila): ?>
      <tr>
        ...
        <td>
          ...
          <a href="?delete=<?= $fila['IdSeguro'] ?>" class="btn btn-small btn-red" onclick="return confirm('¿Deseas eliminar el registro correspondiente al siguiente id = <?= $fila['IdSeguro'] ?> ?')"> Delete </a>
        </td>
      </tr>
<?php endforeach; ?>
    </tbody>
